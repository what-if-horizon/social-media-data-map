...
input_directory = Path('/projects/prjs2007/data_donation/ddd_processed/00_ingest/001_json_structures/x') 
output_directory =  Path('/projects/prjs2007/data_donation/ddd_processed/00_ingest/002_individual_flattened_structures/x')
