...
output_dir = '/projects/prjs2007/data_donation/ddd_development_20rows/01_path_standardisation/011_classified_paths'
...
def main():
    iS.run_id_std(input_file, output_dir, id_dir, country_list, model,  num_agents = 4, sample = 20)
